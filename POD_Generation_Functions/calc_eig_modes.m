function [pod_u, pod_v, lambda2, eig_func_norm] = calc_eig_modes(co_var, num_modes, ...
...
eig_func_norm = eig_func*sqrt(lambda2)*sqrt(sz_co_var);
...
eig_func_norm = eig_func_norm(:,1:num_modes);
