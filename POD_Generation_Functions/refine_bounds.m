function [bnd_x, bnd_y, bnd_idx] = ...
    refine_bounds(x, y, u, v, mean_u, mean_v, direct, streamlines, update_bnds)
...
if exist([direct filesep 'Processed Data' filesep 'Mask' filesep 'Mask.mat'], 'file') && ~update_bnds
    ...
    % Open GUI
    [bnd_x, bnd_y, bnd_idx] = mask_gen(data, bnd_x, bnd_y, u, v, streamlines);
