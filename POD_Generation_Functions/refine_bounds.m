function [bnd_X, bnd_idx] = refine_bounds(X, X_direct, U, mean_U, direct, streamlines, update_bnds)
...
if exist([direct filesep 'Processed Data' filesep 'Mask' filesep 'Mask.mat'], 'file') && ~update_bnds
    ...
    bnd_X = edge_boundaries(bnd_idx, X, X_direct);
    ...
    % Open GUI
    [bnd_X, bnd_idx] = mask_gen(data, U, X_direct, streamlines);
