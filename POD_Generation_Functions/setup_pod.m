...
problem_airfoil.u_scale_gen = @u_scale_gen_shear;
problem_base1.save_figures = {'fig', 'jpg'};
problem_base1.sides = {'left', 'right'};
...
problem_airfoil.sides = {'left', 'right', 'top', 'bottom'};
...
problem_cavity.sides = {'left', 'right', 'top'};
