...
while i < dimensions(1) 
    while j < dimensions(2)
        ...
        while bnd_idx(i,j) ~= -1 && j < dimensions(2)
            gap = gap + 1;
            j = j + 1;
        end
...
while j < dimensions(2)
    while i < dimensions(1) 
        ...
        % Determine number of spaces until a boundary or edge of image
        while bnd_idx(i,j) ~= -1 && i < dimensions(1)
            gap = gap + 1;
            i = i + 1;
        end
