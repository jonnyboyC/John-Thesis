...
for i = 1:length(tke_fields)
    ...
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fkm, tke.(tke_fields{i}), 'k-means \sigma_{d}', ...
    ...
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fgmm, tke.(tke_fields{i}), 'GMM \sigma_{d}', ...
    ...
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pkm, tke.(tke_fields{i}), 'k-means \sigma_{l}', ...
    ...
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pgmm, tke.(tke_fields{i}), 'GMM \sigma_{l}', ...
...
for i = 1:length(amp1_fields)
    ...
    % compare to k-means trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fkm, amp1.(amp1_fields{i}), 'k-means \sigma_{d}', ...
    ...
    % compare to gmm trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fgmm, amp1.(amp1_fields{i}), 'GMM \sigma_{d}', ...
    ...
    % compare to k-mean likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pkm, amp1.(amp1_fields{i}), 'k-means \sigma_{l}', ...
    ...
    % compare to gmm likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pgmm, amp1.(amp1_fields{i}), 'GMM \sigma_{l}', ...
...
for i = 1:length(amp2_fields)
    ...
    % compare to k-means trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fkm, amp2.(amp2_fields{i}), 'k-means \sigma_{d}', ...
    ...
    % compare to gmm trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fgmm, amp2.(amp2_fields{i}), 'GMM \sigma_{d}', ...
    ...
    % compare to k-mean likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pkm, amp2.(amp2_fields{i}), 'k-means \sigma_{l}', ...
    ...
    % compare to gmm likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pgmm, amp2.(amp2_fields{i}), 'GMM \sigma_{l}', ...
...
for i = 1:length(freq_fields)
    ...
    % compare to k-means trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fkm, fft.(freq_fields{i}), 'k-means \sigma_{d}', ...
    ...
    % compare to gmm trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fgmm, fft.(freq_fields{i}), 'GMM \sigma_{d}', ...
    ...
    % compare to k-mean likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pkm, fft.(freq_fields{i}), 'k-means \sigma_{l}', ...
    ...
    % compare to gmm likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pgmm, fft.(freq_fields{i}), 'GMM \sigma_{l}', ...
...
for i = 1:length(phase_fields)
    ...
    % compare to k-means trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fkm, phase.(phase_fields{i}), 'k-means \sigma_{d}', ...
    ...
    % compare to gmm trasnition norm score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, fgmm, phase.(phase_fields{i}), 'GMM \sigma_{d}', ...
    ...
    % compare to k-mean likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pkm, phase.(phase_fields{i}), 'k-means \sigma_{l}', ...
    ...
    % compare to gmm likelihood score
    [~, R2, R, p] = score_plot(full_name, sub_name, steady, pgmm, phase.(phase_fields{i}), 'GMM \sigma_{l}', ...
